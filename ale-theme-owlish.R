...
.ace_marker-layer .ace_selection {
  background: rgba(95, 126, 151, 0.47);
}  
.ace_selection.ace_start {
	box-shadow: 0 0 3px 0px #011627;
  border-radius: 2px;
}  
...
.terminal .xterm-selection div {
  ...
  background-color: #011627;
  overflow-y: scroll;
} .xtermInvertColor { color: #011627; }
.xtermInvertBgColor { background-color: #d6deeb; }
...
.xtermBgColor255 { background-color: #eeeeee; } .rstudio-themes-flat.editor_dark.ace_editor_theme a {
   color: #FFF !important;
}
...
.ace_marker-layer .ace_active-line {
  background: #010e1a;
  position: absolute;
>>>>>>> 802e2917cd1aafeb1f9b3f43a9c2f986e1bd3441
}